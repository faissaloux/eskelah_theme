...
<section class="ServicesPageHeader">
    <div class="container">
        ...
        <img class="header-serv" src="<?php echo $vectors; ?>about/about_us_header.png" />
    </div>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="serviceBox">
                    <div class="serviceImg visual-production-serviceImg"><img
                            src="<?php echo $vectors; ?>/services2/XMLID_1069_.png" alt=""></div>
                    <h3 class="serviceTitle">الإنتاج المرئي</h3>
                    <p class="serviceDescription">
                        نعاونك على حبك ظهورك المرئي، من الفكرة إلى الإخراج، بأفضل الطرق المتبعة في الكتابة و الإنتاج و
                        بأحدث المعدات.
                    </p>
            ...
            <div class="col-md-4">
                <div class="serviceBox">
                    ...
                    <p class="serviceDescription">
                        نبني هنا تواجدك الرقمي، من الفكرة إلى الإحصاء و التطوير، بتفعيل منصاتك الرقمية: لتبقى دائما في
                        ذهن فئتك المستهدفة.
                    </p>
                    <div class="serviceButton">
