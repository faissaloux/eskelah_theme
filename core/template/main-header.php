        ...
        <div class="modal-content">
            <div class="modal-body">
                <div style="padding:56.25% 0 0 0;position:relative;"><iframe
                        src="https://player.vimeo.com/video/320867392?title=0&byline=0&portrait=0"
                ...
                <div class="flex-row">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="<?php bloginfo('url'); ?>"><img
                                src="<?php echo $vectors; ?>le-logo.svg" alt=""></a>
                    </div>
    ...
    <div class="col-md-8 col-md-offset-2  col-xs-12 contact-form ">
        ...
        <form id="MaindemandeForm" class="form">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="form-group">
                        <input type="text" placeholder="ما هي ميزانيتك التقريبية؟" class='form-control inpt raleway'
                            id="your_bidget" />
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <div class="form-group">
                        <input type="text" placeholder="البريد الإلكتروني" class='form-control inpt raleway'
                            id="your_email" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="form-group">
                        <textarea name="" id="your_message" class='form-control inpt txtarear' id=""
                            placeholder="هل تود إخبارنا بشيء ما؟" cols="30" rows="10"></textarea>
                    </div>
                </div>
            </div>
