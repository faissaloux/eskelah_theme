...
<style>
    @media screen and (min-width: 800px) {
        .dlkdlkdldkldkdlkd { display:none !important;}
    }
    .icon {
        height: 100px;
    }
        ...
        <div class="col-md-6" id="counters-eskelah">
            <div class="col-md-12">
                <div class="about-left">
                    ...
                    نصنع في إسكلة حلولا متكاملة من خدمات الإنتاج المرئي و التسويق الرقمي و تطوير الهويات التجارية، من البحث و الإعداد إلى الإنتاج و الإطلاق!
                    </p>
                </div> 
            </div>
 ...
 <section class="why-esklah">
     <div class="container">
       ...
       <div class="col-md-4">
           <div class="icon-box">
               <div class="icon">
                   <img src="<?php echo $vectors; ?>/home/a1.png" alt="" />
               </div>
               <div class="heading">
                   <h2>الإبداع</h2>
               </div>
         ...
         <div class="col-md-4">
           <div class="icon-box">
               <div class="icon">
                   <img src="<?php echo $vectors; ?>/home/a2.png" alt="" />
               </div>
               <div class="heading">
                   <h2>المحلية</h2>
               </div>
         ...
         <div class="col-md-4">
           <div class="icon-box">
               <div class="icon">
                   <img src="<?php echo $vectors; ?>/home/a3.png" alt="" style="margin-top: 24px;"/>
               </div>
               <div class="heading">
                   <h2>الشغف</h2>
               </div>
