...
<section class="portfolio">
    ...
    <div class="col-md-6 hidden-xs">
        <div class='frame' >
            ...
            <a href="javascript:;" class="show-project-video" data-toggle="modal" data-target="#video_project" data-video="<?php echo $video_link ?>">
            <?php if($video_link): ?>
        ...
        <?php $class = ($count % 2 == 1) ? "odd" : "even"; ?>
            <div class="col-md-8 col-md-offset-2  col-sm-8 projectDisplay <?php echo $class; ?> hidden-sm hidden-lg hidden-md">
