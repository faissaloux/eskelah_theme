 ...
 <div class="container">
  <div class="col-md-7">
      <div class="projectInfo">
          <h1><?php the_title(); ?></h1>
          <p><pre><?php  echo $little_description; ?></pre> 
          </p>
          <ul>
              <li><a href="http://www.facebook.com/sharer.php?u=<?php echo get_permalink(); ?>"><img src="<?php echo $vectors; ?>/projectShare/facebook.png" alt=""></a></li>
              <li><a href="https://twitter.com/intent/tweet?text=<?php echo get_permalink(); ?>"><img src="<?php echo $vectors; ?>/projectShare/twitter.png" alt=""></a></li>



              <li><a href="whatsapp://send?text=<?php echo get_permalink(); ?>" data-action="share/whatsapp/share" ><img src="<?php echo $vectors; ?>/projectShare/whatsapp.png" alt=""></a></li>
          </ul>
      </div>
  </div>
  <div class="col-md-5">
...
<section class="SeeMoreProjects circle_shape"> 
    ...
    <div class="container">
        <div class="watchMoreTitl"><h3>شاهد المزيد من أعمالنا</h3></div>
        <div class="col-md-12">
